...
You can install the released version of `nBootstrap` from [GitHub](https://github.com/jeksterslab-r/nBootstrap) with:
...
See [GitHub Pages](https://jeksterslab-r.github.io/nBootstrap/index.html)
